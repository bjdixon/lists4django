...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lists_list', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.User'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'lists.item': {
            'Meta': {'object_name': 'Item', 'ordering': "('id',)", 'unique_together': "(('list', 'text'),)"},
        ...
        'lists.list': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['accounts.User']", 'blank': 'True'})
        }
    }
